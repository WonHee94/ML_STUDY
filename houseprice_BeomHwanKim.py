...
# 평가로는 RMSE를 사용합니다.
# 
# 비슷한 대회로는 데이콘에서 열린 직방 모델링 대회와 캐글에서 열린 House Prices: Advanced Regression Techniques가 있습니다.
...
df_train = pd.read_csv('C:/Users/tpfvk/Desktop/train.csv (1)/train.csv')
df_test  = pd.read_csv('C:/Users/tpfvk/Desktop/test.csv')
...
# 위에서 lat의 경우 price와 상관성이 높은 것을 볼 수 있었습니다. 위의 지역은 시애틀인데 시애틀은 북쪽으로 갈 수록 살기 좋은 집들이 많다고 합니다.
